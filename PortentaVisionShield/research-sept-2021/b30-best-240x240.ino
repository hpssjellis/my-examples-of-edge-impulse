...
void setup()
{
    ...
    //   map cutout of the Edge Impulse model to the 128 x 64 OLED screen
...
*/
    ...
    u8g2.setDrawColor(1);               // regular white on black OLED
...
void ei_printf(const char *format, ...) {
 ...
 #ifdef CORE_CM4  //The M4 core does not print
    // do nothing
 #else // all other microcontrollers can serial print
